...
public class DetailOrderedAdapter extends RecyclerView.Adapter<DetailOrderedAdapter.ViewHolder>{

    private Context mContext;
    private List<ShoeInBag> mlist = new ArrayList<>();

    public DetailOrderedAdapter(Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View DetailOrderedAdapter = inflater.inflate(R.layout.order_product, parent, false);
        DetailOrderedAdapter.ViewHolder viewHolder = new DetailOrderedAdapter.ViewHolder(DetailOrderedAdapter);
        return viewHolder;
    }
